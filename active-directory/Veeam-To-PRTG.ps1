...
#region: Backup Jobs
if ($includeBackup) {
    $seshListBk = @($allSesh | Where-Object{($_.CreationTime -ge (Get-Date).AddHours(-24)) -and $_.JobType -eq "Backup"} | Group-Object -Property 'JobName' | ForEach-Object { $_.Group | Sort-Object -Property 'CreationTime' -Descending | Select-Object -First 1})           # Gather all Backup sessions within timeframe
...
#region: Copy Jobs
if ($includeCopy) {
    $seshListBkc = @($allSesh | Where-Object{($_.CreationTime -ge (Get-Date).AddHours(-24)) -and $_.JobType -match "BackupSync|SimpleBackupCopyWorker"} | Group-Object -Property 'JobName' | ForEach-Object { $_.Group | Sort-Object -Property 'CreationTime' -Descending | Select-Object -First 1})     # Gather all BackupCopy sessions within timeframe
...
if ($includeRepl) {
    $seshListRepl = @($allSesh | Where-Object{($_.CreationTime -ge (Get-Date).AddHours(-24)) -and $_.JobType -eq "Replica"} | Group-Object -Property 'JobName' | ForEach-Object { $_.Group | Sort-Object -Property 'CreationTime' -Descending | Select-Object -First 1})
...
if ($includeEP) {
    $seshListEP = Get-VBRComputerBackupJobSession | Where-Object{($_.CreationTime -ge (Get-Date).AddHours(-$HourstoCheck))} | Group-Object -Property 'Name' | ForEach-Object { $_.Group | Sort-Object -Property 'CreationTime' -Descending | Select-Object -First 1}     # Gather all EP sessions within timeframe
